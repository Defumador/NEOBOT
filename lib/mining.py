...
# get coordinates of EVE client window borders, assuming 1024 x 768 resolution
# search for EVE logo in top left of client window, this is the new zero
origin = pag.locateCenterOnScreen
originx, originy = origin

windowx = originx + 1024
windowy = originy + 768
