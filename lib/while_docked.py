import random, os, sys #import module to allow for Random command in ahk
from mouse import *
...
def open_station_hangar(): #click on station hangar button in inventory window while docked
    ...
    print(station_hangar_icon)
    if station_hangar_icon == None:
...
def focus_inventory_window(): #click inside the station inventory window to focus it before items are selected
    sorting_station_hangar_icon = pyautogui.locateCenterOnScreen('sorting_station_hangar_icon.png') #look for sorting buttons in top right corner of inventory window and offset mouse
    print(sorting_station_hangar_icon)
    if sorting_station_hangar_icon == None:
...
def drag_items_to_cargo_bay(): #drag items from inventory into ship cargo bay
    ...
    print(namefield_station_hangar_icon)
    if namefield_station_hangar_icon == None:
        print('cant find namefield_station_hangar_icon')
        sys.exit()
    else:
        inventory_current_ship_icon = pyautogui.locateCenterOnScreen('inventory_current_ship_icon.png') #look for ship cargo bay icon in inventory sidebar
        print(inventory_current_ship_icon)
        if inventory_current_ship_icon == None:
